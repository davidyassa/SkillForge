...
public class QuizCreationDialog extends JDialog {
    ...
    private void addQuestionDialog() {
        ...
        p.add(new JLabel("Question Text:"));
        p.add(qText);
        p.add(new JLabel("Option 1:"));
        p.add(op1);
        p.add(new JLabel("Option 2:"));
        p.add(op2);
        p.add(new JLabel("Option 3:"));
        p.add(op3);
        p.add(new JLabel("Option 4:"));
        p.add(op4);
        p.add(new JLabel("Correct Option:"));
        p.add(correctBox);
